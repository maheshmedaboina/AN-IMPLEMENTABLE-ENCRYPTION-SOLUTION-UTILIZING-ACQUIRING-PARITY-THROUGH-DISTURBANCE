...
<%@page import="javafx.scene.shape.QuadCurve"%>
        ...
        <div id="head">
            ...
            <div id="h2">
                ...
                <ul>
                    ...
                    <li><a href="VBlockedUsers.jsp"  style="color:whitesmoke;">View Blocked Users</a></li>
                 ...
                 <div id="ma">
                       <center><H2>All Blocked Users</H2>
                           <table>
                               <tr>
                                   <th>ID</th>
                                   <th>Blocked By</th>
                               ...
                               ResultSet t=Queries.getExecuteQuery(query);
                               while(t.next()){
                                %>
                                <tr>
