    ...
    <body>
        <div id="head">
            ...
            <div id="h2">
                ...
                <ul>
                      <li><a href="Regster.jsp">REGISTER</a></li>
                    <li><a href="User.jsp"style="color:whitesmoke;">USER</a></li>
                       ...
                       <form action="UserAction.jsp" method="post">
                           <table style="width:300px;height:200px;">
                               <tr><th>USERNAME</th><td><input type="text" name="uname" required=""></td></tr>
                                 ...
                                 <tr><td>Don't Have An Account ?</td><td><a href="Regster.jsp">Register</a></td></tr>
                           </table>
                       </form>
 </center>
            </div>
